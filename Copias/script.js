...
document.addEventListener('keydown', (e) => {
    ...
    // Gestão da barra lateral (.sidebar-tv)
    if (focused.closest('.sidebar-tv')) {
        ...
        if (e.key === 'ArrowDown') {
            ...
            if (focused === searchInput) {
                return; // Deixa o listener específico tratar (vai para o microfone)
            }
            e.preventDefault();
            ...
            if (focused === micBtn) {
                return; // Deixa o listener específico tratar (volta para a caixa de texto)
            }
        }
    }
...
// ==========================================
// Navegação Horizontal Específica (Caixa ↔ Microfone)
// ==========================================
if (searchInput) {
